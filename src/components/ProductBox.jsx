							...
							<div className='col-sm-3 col-12 mb-sm-0 mb-3'>
								<div className='row align-items-sm-start align-items-center'>
									...
									<div className='col-sm-10 col-8'>
										<img src={product?.cover} alt='product' loading='lazy' className='img-fluid' style={{ borderRadius: '4px' }} />
									</div>
								</div>
							</div>
							<div className='col-sm-9 col-12'>
								<div className=' d-flex justify-content-between mb-4'>
									<div className='product-name d-flex align-items-center p-3'>
										<span>{product?.name}</span>
									</div>
									<div className='product-category d-flex align-items-center justify-content-center'>{product?.category?.name}</div>
								</div>
								...
								<div className=' d-flex justify-content-between align-items-center flex-wrap'>
									<div className='product-price '>
										...
										<div className='input d-flex justify-content-center align-items-center'>
											...
											<div className='currency d-flex justify-content-center align-items-center'>ريال</div>
										</div>
									</div>
									<div className='product-price'>
