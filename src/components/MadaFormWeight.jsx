	...
	return (
		<form style={formStyle} onSubmit={handleSubmit}>
			<div className='row mb-3'>
				...
				<div className='col-12'>
					<input id='owner-name' type='text' name='owner-name' style={{ padding: '18px', ...inputsStyle }} />
				</div>
			</div>
			<div className='row mb-3'>
				<div className='col-12'>
					...
					<FormControl sx={{ m: 0, width: '100%' }}>
						<Select
							...
							renderValue={(selected) => {
								if (selectBank === '') {
									return <span style={{ color: '#67747B' }}> اختر البنك المعتمد</span>;
								}
								return selected;
							}}
						>
			...
			<div className='row mb-3'>
				...
				<div className='col-12'>
					<input id='account-nmuber' type='text' name='account-nmuber' style={{ padding: '18px', ...inputsStyle }} />
				</div>
			</div>
			<div className='row mb-4'>
				...
				<div className='col-12'>
					<input id='IBAN' type='text' name='IBAN' style={{ padding: '18px', ...inputsStyle }} />
				</div>
			</div>
