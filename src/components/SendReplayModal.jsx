...
const SendReplayModal = ({ commentDetails, reload, setReload }) => {
	...
	return (
		<div className='send-replay-modal' open={isOpenReplyModal}>
			<Modal onClose={() => dispatch(closeReplyModal())} open={isOpenReplyModal} aria-labelledby='modal-modal-title' aria-describedby='modal-modal-description'>
				<Box sx={style}>
					<div className=''>
						<h3 className='d-flex justify-content-center align-items-center ' style={headingStyle}>
							ارسال رد
						</h3>
						<div>
							<div className=''>
								<p style={contentStyles} className='d-flex justify-content-start align-items-center mb-4 px-3'>
									إلى :<span style={{ color: '#67747B', marginRight: '14px' }}>{commentDetails?.user?.email} </span>
								</p>
									...
									<Editor
										...
										placeholder={
											<div className='d-flex flex-column  '>
												<p style={{ fontSize: '20px', fontWeight: '500', color: '#011723' }}> شكراً أسيل </p>
												<p style={{ fontSize: '20px', fontWeight: '500', color: '#011723' }}> سعداء بتسوقك من متجرنا </p>
											</div>
										}
					...
					<div className='d-flex justify-content-center gap-4 mb-4 '>
						...
						>
							<span style={{ marginLeft: '16px' }}>
								<FiSend style={{ color: '#EFF9FF', width: '18px', height: '18px' }} />
							</span>
