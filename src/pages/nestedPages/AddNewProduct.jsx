				...
				<Modal open={true} onClose={() => navigate('/Products')} aria-labelledby='modal-modal-title' aria-describedby='modal-modal-description'>
					<Box sx={style}>
						<div className='add-form-wrapper'>
							...
							<form className='form-h-full' onSubmit={handleSubmit(addNewProduct)}>
								<div className='form-body'>
									...
									<div className='row mb-md-5 mb-3'>
										...
										<div className='col-md-3 col-12'></div>
										<div className='col-md-7 col-12'><span className='fs-6 text-danger'>{productError?.name}{errors?.name && errors.name.message}</span></div>
									</div>
									<div className='row mb-md-5 mb-3'>
										<div className='col-md-3 col-12'>
										...
										<div className='col-md-3 col-12'></div>
										<div className='col-md-7 col-12'><span className='fs-6 text-danger'>{productError?.description}{errors?.description && errors.description.message}</span></div>
									</div>
									<div className='row mb-md-5 mb-3'>
										<div className='col-md-3 col-12'>
										...
										<div className='col-md-3 col-12'></div>
										<div className='col-md-7 col-12'><span className='fs-6 text-danger'>{productError?.category_id}{errors?.category_id && errors.category_id.message}</span></div>
									</div>
									<div className='row mb-md-5 mb-3'>
										<div className='col-md-3 col-12'>
									...
									<div className='row mb-md-5 mb-3'>
										...
										<div className='col-md-3 col-12'></div>
										<div className='col-md-7 col-12'><span className='fs-6 text-danger'>{productError?.stock}{errors?.stock && errors.stock.message}</span></div>
									</div>
									...
									<div className='row mb-md-5 mb-3'>
										...
										<div className='col-md-3 col-12'></div>
										<div className='col-md-7 col-12'><span className='fs-6 text-danger'>{productError?.selling_price}{errors?.selling_price && errors.selling_price.message}</span></div>
									</div>
									<div className='row mb-md-5 mb-3'>
										<div className='col-md-3 col-12'>
									...
									<div className='row mb-md-5 mb-3'>
										...
										<div className='col-md-3 col-12'></div>
										<div className='col-md-7 col-12'><span className='fs-6 text-danger'>{productError?.discount_percent}{errors?.discount_percent && errors.discount_percent.message}</span></div>
									</div>
									...
									<div className='row mb-3'>
										...
										<div className='col-md-3 col-12'></div>
										<div className='col-md-7 col-12'><span className='fs-6 text-danger'>{productError?.SEOdescription}{errors?.SEOdescription && errors.SEOdescription.message}</span></div>
									</div>
								</div>
