							...
							<div className='form-body'>
								<div className='row mb-md-4 mb-3 d-flex flex-row-reverse justify-content-between'>
									<div className='col-md-4 col-12 mb-3 mb-md-0'>
										<ImageUploading
											value={customerImage}
											onChange={handleAddCustomerImage}
											dataURLKey='data_url'
										...
										<input
											...
											{...register("ID_number", {
												...
												pattern: {
													value: /^[^-\s][a-zA-Z0-9_]+$/,
													message:
														"The ID number must be a English letter and number",
												},
											})}
										/>
										<div className='col-12'>
											<span className='fs-6 text-danger'>
												{customerError?.ID_number}
							...
							<div className='form-footer'>
								<div className='row d-flex justify-content-center align-items-center'>
									...
									<div className='col-md-4 col-6'>
										<button
											className='close-btn'
											onClick={() => dispatch(closeCustomerDataModal())}>
											إلغاء
										</button>
									</div>
								</div>
