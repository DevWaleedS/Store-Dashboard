...
const EditUserDetails = () => {
	const { fetchedData, loading, reload, setReload } = useFetch('https://backend.atlbha.com/api/Store/profile');
	...
	const files = userImage.map((file) => (
		<li key={file.path} style={{ width: '100%', overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis' }}>
											...
											<div className='user-details-body edit-user-body'>
												<div className='row mb-5'>
													<div className='col-lg-2 col-12 d-flex justify-content-center'>
														{/** preview banner here */}
														<div className=' banners-preview'>{bannersImage.length === 0 ? <img className='img-fluid' src={fetchedData?.data?.users?.image} alt='user' /> : bannersImage}</div>
													</div>
													...
													<div className='col-lg-4 col-12 d-flex justify-content-center order-md-last order-first'>
														<div className='job-title'>{fetchedData?.data?.users?.role?.name}</div>
													</div>
												</div>
												...
												<div className='row mb-md-4 mb-3'>
													<div className='col-lg-4 col-md-5 col-12 mb-md-0 mb-3'>
														...
														/>
														<br />
														<span className='fs-6 text-danger'>{dataError?.user_name}{errors?.user_name && errors.user_name.message}</span>
													</div>
													...
													<div className='col-lg-4 col-md-5 col-12'>
														...
														<br />
														<span className='fs-6 text-danger'>{dataError?.password}{errors?.password && errors.password.message}</span>
													</div>
												</div>
												<div className='row mb-md-4 mb-3'>
													<div className='col-lg-4 col-md-5 col-12'>
														...
														/>
														<br />
														<span className='fs-6 text-danger'>{dataError?.email}{errors?.email && errors.email.message}</span>
													</div>
													<div className='col-md-2 col-0'></div>
													...
													<div className='col-lg-4 col-md-5 col-12 order-md-last order-first mb-md-0 mb-3'>
														...
														<span className='password-hint'>أدخل أرقام وحروف ورموز</span>
														<br />
														<span className='fs-6 text-danger'>{dataError?.confirm_password}{errors?.confirm_password && errors.confirm_password.message}</span>
													</div>
												</div>
												<div className='row mb-md-4 mb-3'>
													...
													<br />
													<span className='fs-6 text-danger'>{dataError?.image}</span>
												...
												<div className='row mb-4'>
													<div className='col-lg-4 col-12'>
														...
														<br />
														<span className='fs-6 text-danger'>{dataError?.phonenumber}{errors?.phonenumber && errors.phonenumber.message}</span>
													</div>
													<div className='col-lg-2 col-0'></div>
													<div className='col-lg-4 col-0'></div>
												</div>
											...
											<div className='user-details-footer'>
												<div className='row d-flex justify-content-center align-items-center'>
													...
													<div className='col-lg-3 col-md-6 col-12'>
														<button type='button' onClick={() => navigate('/')} className='close-btn w-100 mb-3'>
															إغلاق
														</button>
													</div>
												</div>
