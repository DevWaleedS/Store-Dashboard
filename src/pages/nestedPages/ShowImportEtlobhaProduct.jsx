...
const ShowImportEtlobhaProduct = () => {
	...
	const updateImportProduct = (data) => {
		...
		axios
			.post(`https://backend.atlbha.com/api/Store/updateimportproduct/${fetchedData?.data?.products?.id}`, formData, {
				headers: {
					...
					<Box sx={style}>
						<div className='add-form-wrapper'>
							...
							{loading ? (
								...
								<form className='form-h-full' onSubmit={handleSubmit(updateImportProduct)}>
									<div className='form-body'>
										...
										<div className='row mb-md-5 mb-3'>
											...
											<div className='col-md-7 col-12'>
												<div className='main-category category mb-3'>
													<input className='input' type='text' value={fetchedData?.data?.products?.category?.name} onChange={() => console.log('')} disabled={true} />
												</div>
											</div>
											<div className='col-md-3 col-12'></div>
										</div>
										...
										<div className='row mb-md-5 mb-3'>
											...
											<div className='col-md-7 col-12'>
												<div className='d-flex justify-content-center align-items-center' style={{ background: '#eeeeef', border: '1px solid #a7a7a71a', height: '45px' }}>
													<div className='currency_icon d-flex justify-content-center align-items-center'>
														<CurrencyIcon />
													</div>
													<div className='price w-100 d-flex justify-content-center align-items-center import_products_input'>{fetchedData?.data?.products?.purchasing_price}</div>
										...
										<div className='row mb-md-5 mb-3'>
											...
											<div className='col-md-7 col-12'>
												<div className='d-flex justify-content-center align-items-center' style={{ background: '#eeeeef', border: '1px solid #a7a7a71a', height: '45px' }}>
													<div className='price w-100 d-flex justify-content-center align-items-center import_products_input'> {fetchedData?.data?.products?.stock}</div>
												</div>
											</div>
											<div className='col-md-3 col-12'></div>
										</div>
