...
const UserDetails = () => {
	const { fetchedData, loading } = useFetch('https://backend.atlbha.com/api/Store/profile');
									...
									<div className='user-details-body'>
										<div className='row'>
											<div className='col-lg-2 col-12 d-flex justify-content-center'>
												<img className='img-fluid' src={fetchedData?.data?.users?.image} alt={fetchedData?.data?.users?.name} />
											</div>
