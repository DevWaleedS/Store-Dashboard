...
const CreateRole = () => {
	const { fetchedData, loading, reload, setReload } = useFetch('https://backend.atlbha.com/api/Store/permissions');
									...
									<div className='mb-md-5 mb-3'>
										<div className='search-wrapper'>
											<div className='col-md-6 col-12'>
												...
												/>
												<br />
												<span className='fs-6 text-danger'>{errors?.role_name && errors.role_name.message}</span>
											</div>
										</div>
									</div>
														...
														<Table>
															...
															>
																<TableRow>
																	...
																	<TableCell align='center'>تفعيل-تعطيل</TableCell>
																</TableRow>
															</TableHead>
															<TableBody>
																{
																	loading ?
																		...
																		:
																		(
																			fetchedData?.data?.permissions?.map((row, index) => (
																				<TableRow key={index}>
																					<TableCell
																						sx={{
																							border: 'none',
