...
const OfferDetails = () => {
	const { id } = useParams();
	const { fetchedData } = useFetch(`https://backend.atlbha.com/api/Store/offer/${id}`);
	...
	useEffect(() => {
		...
		if (fetchedData?.data?.offers?.start_at && fetchedData?.data?.offers?.end_at) {
			...
			setEndDate(moment(fetchedData?.data?.offers?.end_at, 'YYYY-MM-DD').toDate());
		} else {
			setStartDate('');
			setEndDate('');
		}
									...
									<div className='form-body'>
										...
										<div className='row  d-flex  justify-content-evenly'>
											<div className='col-md-6 col-12 mb-md-0 mb-3'>
												...
												<DatePicker disabled selected={startDate} placeholderText='تاريخ بداية العرض ' onChange={(date) => setStartDate(date)} dateFormat='yyyy-MM-dd' />
											</div>
											<div className='col-md-6 col-12'>
												...
												<DatePicker disabled selected={endDate} placeholderText='تاريخ  نهاية العرض ' onChange={(date) => setEndDate(date)} dateFormat='yyyy-MM-dd' />
											</div>
										</div>
									</div>
								</div>
										...
										<div className='form-body'>
											...
											<div className='row mb-md-5 mb-3 d-flex  justify-content-evenly'>
												...
												>
													<div className='col-md-6 col-12'>
														<div className='radio-box mb-1 '>
															<FormControlLabel disabled value='product' id='product' control={<Radio />} />
														...
														<div className='mx-md-3'>
															<div className='col-12'>
																...
																<input value={purchase_serach} onChange={(e) => purchaseSearchItems(e.target.value)} type='text' placeholder='البحث في المنتجات.' disabled />
															</div>
															{purchase_serach !== '' && (
													...
													<div className='col-md-6 col-12'>
														<div className='radio-box mb-1'>
															<FormControlLabel disabled id='category' control={<Radio />} value='category' />
													...
													<div className='col-md-6 col-12'>
														...
														<div className='mx-md-3'>
															<div className='col-12'>
																...
																<input value={get_serach} onChange={(e) => getSearchItems(e.target.value)} type='text' placeholder='البحث في المنتجات.' disabled />
															</div>
															{get_serach !== '' && (
																<ul className='purchase_serach'>
											...
											<div className='row d-flex  justify-content-evenly'>
												...
												>
													<div className='col-6'>
														<div className='radio-box mb-1 '>
															<FormControlLabel disabled id='percent' control={<Radio />} value='percent' />
															<label className={offer?.offer1_type === 'percent' ? 'active me-3' : ' me-3'} htmlFor='percent'>
																نسبة خصم
															</label>
														</div>
													...
													<div className='col-6'>
														<div className='radio-box mb-1'>
															<FormControlLabel disabled id='free_product' control={<Radio />} value='free_product' />
															<label className={offer?.offer1_type === 'free_product' ? 'active me-3' : ' me-3'} htmlFor='free-product'>
																منتج مجاني
															</label>
														</div>
													</div>
										...
										<div className='form-body'>
											...
											<div className='row mb-md-5 mb-3 d-flex justify-content-evenly'>
												<div className='col-12'>
													...
													>
														<div className='radio-box'>
															<FormControlLabel disabled value='all' id='all' control={<Radio />} />
															<label className={offer?.fixed_offer_apply === 'all' ? 'active me-3' : ' me-3'} htmlFor='all'>
																جميع المنتجات
															</label>
														</div>
														<div className='radio-box'>
															<FormControlLabel disabled value='selected_product' id='selected_product' control={<Radio />} />
															<label className={offer?.fixed_offer_apply === 'selected_product' ? 'active me-3' : ' me-3'} htmlFor='selected_product'>
																منتجات مختارة
															</label>
														</div>
														<div className='radio-box'>
															<FormControlLabel disabled value='selected_category' id='selected_category' control={<Radio />} />
															<label className={offer?.fixed_offer_apply === 'selected_category' ? 'active me-3' : ' me-3'} htmlFor='selected_category'>
																تصنيفات مختارة
															</label>
														</div>
														<div className='radio-box'>
															<FormControlLabel disabled value='selected_payment' id='selected_payment' control={<Radio />} />
											...
											{offer?.fixed_offer_apply === 'selected_product' && (
												<div className='mx-md-3'>
													<div className='col-12'>
														...
														<input value={fixed_serach} onChange={(e) => fixedSearchItems(e.target.value)} type='text' placeholder='البحث في المنتجات.' disabled />
													</div>
													{fixed_serach !== '' && (
														<ul className='purchase_serach'>
