...
const RegisterBox = () => {
    ...
    useEffect(() => {
        if (confirmPassword !== '' && password !== confirmPassword) {
            setConfirmPasswordError('كلمة المرور وتأكيد كلمة المرور لاتتطابق');
        } else {
                ...
                <div className='user-form'>
                    ...
                    <div className='content'>
                        <form onSubmit={handleSubmit}>
                            <div className='name'>
                                <h5 className="d-flex flex-row">اسم المستخدم <span style={{ color: "red" }}>*</span></h5>
                                <input
                ...
                <div className='owner-form'>
                    <div className='owner-form'>
                        <div className='box-pay'>
                            ...
                            <button
                                disabled={
                                    !validUserName || !validPssWord || !validConfirmPssWord || !validEmail || isChecked === 0
                                        ? true
                                        : false
                                }
                                className='bt-main'
