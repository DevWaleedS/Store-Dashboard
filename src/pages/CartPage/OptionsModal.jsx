...
function OptionsModal({
    ...
    const [productLessQty, setProductLessQty] = useState(Number(modalData?.less_qty));
    ...
    useEffect(() => {
        if (selectedValues?.filter(value => value !== "")?.length > 0 && modalData?.product?.amount === 1) {
        ...
        <Modal isOpen={openModal} toggle={colseOptionModal} centered size="md">
            <div className="quickview">
                ...
                <div className="product-price">
                    {productPrice} <span className="tax-currency"> ر.س </span><span className="tax-text">السعر شامل الضريبة</span>
                </div>
                ...
                <div className="form-product-option">
                    <label htmlFor="product-quantity">
                        الكمية :
                        <span>أقل كمية للطلب ({handleQut(productLessQty)})</span>
                    </label>
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (newQty < productLessQty) {
                                    toast.error(
                                        `أقل كمية للطلب هي ${+productLessQty}`
                                    );
                            ...
                            <button
                                ...
                                onClick={() => {
                                    if (
                                        ...
                                        toast.error(
                                            `الكمية المتوفرة ${+productStock === 1
                                                ? "قطعة واحدة "
                                                : +productStock === 2
                                                    ? " قطعتين "
                                                    : ` ${+productStock} قطع`
